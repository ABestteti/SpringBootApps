...
public class InsuranceAsset   {
  ...
  public InsuranceAsset type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
   **/
  @Schema(example = "CELI", description = "Indicates the type of account")
      @NotNull
  ...
  public InsuranceAsset origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public InsuranceAsset issuingInstitution(String issuingInstitution) {
    this.issuingInstitution = issuingInstitution;
    return this;
  }

  /**
   * Code of the institution with which the account is opened
   * @return issuingInstitution
   **/
  @Schema(example = "006", description = "Code of the institution with which the account is opened")
      @NotNull
  ...
  public InsuranceAsset accountNumber(String accountNumber) {
  ...
  public InsuranceAsset value(String value) {
    this.value = value;
    return this;
  }
  ...
  public InsuranceAsset accountRole(String accountRole) {
    this.accountRole = accountRole;
    return this;
  }

  /**
   * Describes the client's role in this account. It will indicate whether the account is solely own by the client or is it a joint account
   * @return accountRole
   **/
  @Schema(example = "MAIN/HOLDER", description = "Describes the client's role in this account. It will indicate whether the account is solely own by the client or is it a joint account")
      @NotNull
  ...
  public InsuranceAsset accountStatus(String accountStatus) {
  ...
  public InsuranceAsset transit(String transit) {
  ...
  public InsuranceAsset legislation(String legislation) {
  ...
  public InsuranceAsset accountAliasName(String accountAliasName) {
  ...
  public InsuranceAsset lineOfBusiness(String lineOfBusiness) {
  ...
  public InsuranceAsset convertedValue(String convertedValue) {
  ...
  public InsuranceAsset currency(String currency) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InsuranceAsset insuranceAsset = (InsuranceAsset) o;
    return Objects.equals(this.type, insuranceAsset.type) &&
        Objects.equals(this.origin, insuranceAsset.origin) &&
        Objects.equals(this.issuingInstitution, insuranceAsset.issuingInstitution) &&
        Objects.equals(this.accountNumber, insuranceAsset.accountNumber) &&
        Objects.equals(this.value, insuranceAsset.value) &&
        Objects.equals(this.accountRole, insuranceAsset.accountRole) &&
        Objects.equals(this.accountStatus, insuranceAsset.accountStatus) &&
        Objects.equals(this.transit, insuranceAsset.transit) &&
        Objects.equals(this.legislation, insuranceAsset.legislation) &&
        Objects.equals(this.accountAliasName, insuranceAsset.accountAliasName) &&
        Objects.equals(this.lineOfBusiness, insuranceAsset.lineOfBusiness) &&
        Objects.equals(this.convertedValue, insuranceAsset.convertedValue) &&
        Objects.equals(this.currency, insuranceAsset.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class InsuranceAsset {\n");
